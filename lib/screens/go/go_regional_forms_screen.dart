...
class _OtherFormsTab extends StatelessWidget {
  ...
  static const _sections = [
    _FormSection('Castform (4 formas)', [
      ...
      _FormEntry(351, 'Castform Sunny',  'Fogo',  spriteKey: '351_SUNNY'),
      _FormEntry(351, 'Castform Rainy',  'Água',  spriteKey: '351_RAINY'),
      _FormEntry(351, 'Castform Snowy',  'Gelo',  spriteKey: '351_SNOWY'),
    ]),
