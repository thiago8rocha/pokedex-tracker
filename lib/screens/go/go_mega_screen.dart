...
class _GoMegaScreenState extends State<GoMegaScreen> {
  ...
  Future<void> _openDetail(BuildContext ctx, _GoMega mega) async {
    ...
    final baseName = svc.getName(mega.id);
    final baseTypes = svc.getTypes(mega.id);
    final pokemon = Pokemon(
      id: mega.id, entryNumber: mega.id, name: baseName,
      ...
      baseSpeed: sv('speed'),
      spriteUrl:           'assets/sprites/${st == 'pixel' ? 'pixel' : st == 'home' ? 'home' : 'artwork'}/${mega.id}.webp',
      spriteShinyUrl:      '$base/other/official-artwork/shiny/${mega.id}.png',
      spritePixelUrl:      'assets/sprites/pixel/${mega.id}.webp',
      spritePixelShinyUrl: '$base/shiny/${mega.id}.png',
      spritePixelFemaleUrl: null,
      spriteHomeUrl:       'assets/sprites/home/${mega.id}.webp',
