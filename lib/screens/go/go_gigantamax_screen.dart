...
// Gigantamax confirmados no GO (mar/2026). Tipos verificados no Bulbapedia.
// Gigantamax não altera tipos — são os mesmos da forma base.
const _goGmax = [
...
class _GoGigantamaxScreenState extends State<GoGigantamaxScreen> {
  ...
  Future<void> _openDetail(BuildContext ctx, _GmaxEntry entry) async {
    ...
    final pokemon = Pokemon(
      id: entry.id, entryNumber: entry.id,
      name: 'Gigantamax ${entry.name}',
      types: entry.types,
