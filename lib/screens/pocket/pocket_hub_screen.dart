...
class _PocketHubScreenState extends State<PocketHubScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      endDrawer: _buildPocketDrawer(context),
      bottomNavigationBar: const _PocketBottomNav(),
      body: _loading
          ? const _HubSkeleton()
          : _error != null
...
Widget _buildPocketDrawer(BuildContext context) {
  final scheme = Theme.of(context).colorScheme;
    ...
    return SafeArea(child: Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: InkWell(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            Icon(Icons.nature_people_outlined, size: 22, color: scheme.onSurfaceVariant),
            const SizedBox(height: 2),
            Text('Pokopia', style: TextStyle(fontSize: 10, color: scheme.onSurfaceVariant)),
          ]),
        )),
        // Menu
